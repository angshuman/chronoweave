...
function getClient() {
  ...
  if (process.env.TURSO_DATABASE_URL) {
    ...
    console.warn("[DB] WARNING: No TURSO_DATABASE_URL set on Vercel. Using in-memory DB (data will not persist). Set TURSO_DATABASE_URL and TURSO_AUTH_TOKEN for persistence.");
  } else {
